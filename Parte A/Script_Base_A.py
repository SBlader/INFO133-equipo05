...
cur.execute("CREATE TABLE Prensa (id CHAR(4), Region CHAR(16), Ciudad CHAR(32), Nombre CHAR(32), Contienen CHAR(16), pais CHAR(32), Año_Fundacion DATE, PRIMARY KEY(id))")
